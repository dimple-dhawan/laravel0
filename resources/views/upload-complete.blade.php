        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="text-center" >
                    <img src="{{ $url }}" alt="profile picture" class="img-rounded" style="max-height: 300px;">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="{{ route('profile', Auth::id()) }}" class="btn btn-default" style="width:100%;">Upload Again</a>
                    </div>
                </div>
